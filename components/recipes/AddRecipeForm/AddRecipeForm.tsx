...
export default function AddRecipeForm() {
 ...
 <Field as="textarea" name="descr" placeholder="Enter a brief description" className={styles.textarea} />
                  <ErrorMessage name="descr" component="p" className={styles.error} />
                </div>
                <div className={styles.fieldWrapper}>
                  <label>Cooking time (minutes)</label>
                  <Field type="number" name="cookingTime" className={styles.input} />
                  <ErrorMessage name="cookingTime" component="p" className={styles.error} />
                </div>
                <div className={styles.row}>
                  <div className={styles.fieldWrapper}>
                    <label>Calories</label>
                    <Field type="number" name="cals" className={styles.input} />
                    <ErrorMessage name="cals" component="p" className={styles.error} />
                  </div>
                  <div className={styles.fieldWrapper}>
            ...
            <div className={styles.instructionsSection}>
              ...
              <div className={styles.instructionsWrapper}>
                ...
                <ErrorMessage name="instruction" component="p" className={styles.error} />
              </div>
            </div>
